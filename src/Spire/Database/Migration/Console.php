<?php
namespace Spire\Database\Migration;

use Spire\Console\ConsoleInterface;
use Spire\Console\Output;
...
class Console implements ConsoleInterface
{
    ...
    private function blank($suffix, $module, $migration): string
    {
        ...
        $contents .= "use \Spire\Database\Migration\Blueprint;\n";
        $contents .= "use \Spire\Database\Migration\Migration;\n";
        $contents .= "use \Spire\Database\Migration\Schema;\n\n";
